...
class ProgressTracker: ObservableObject, Codable {
    ...
    @Published var weeklyStats: WeeklyStats = WeeklyStats() // var로 변경하고 기본값으로 초기화
    ...
    required init(from decoder: Decoder) throws {
        ...
        weeklyStats = try container.decodeIfPresent(WeeklyStats.self, forKey: .weeklyStats) ?? WeeklyStats()
